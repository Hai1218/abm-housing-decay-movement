...
model_params = {
    ...
    "base_renovation_cost": mesa.visualization.Slider("Renovation Cost", 
                                                      0.15, 0, 0.5, 0.01,
                                                      description="The base cost for a housing renovation.",
                                                      ),
    "renovation_differential": mesa.visualization.Slider("Renovation Differential", 
                                                         0.15, 0, 0.5, 0.01,
                                                         description="The increased cost for non-regulated housing renovation",
                                                         ),

...
model_params = {
    "rent_discount": mesa.visualization.Slider("%Rent Regulation Rent Discount", 0.5, 0, 0.9, 0.1),
    "decay_differential": mesa.visualization.Slider("%Rent Regulated Decay Differential", 0.05, 0, 0.2, 0.01),
    "base_decay_constant": mesa.visualization.Slider("%Housing Decay Constant", 0.15, 0, 0.5, 0.01),
    "init_num_people": mesa.visualization.Slider("Initial Number of Households", 2, 1, 10, 1),
    "max_complaint": mesa.visualization.Slider("Number of complaints made before Household moves", 5, 1, 10, 1),
}
